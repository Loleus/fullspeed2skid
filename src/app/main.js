...
import { MenuScene } from '../scenes/MenuScene.js?v=2.2.2';
import { LoadingScene } from '../scenes/LoadingScene.js?v=2.2.2';
import { GameScene } from '../scenes/GameScene.js?v=2.2.2';
import { HudScene } from '../scenes/HudScene.js?v=2.2.2';
