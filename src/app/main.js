...
import { MenuScene } from '../scenes/MenuScene.js?v=2.3.9';
import { LoadingScene } from '../scenes/LoadingScene.js?v=2.3.9';
import { GameScene } from '../scenes/GameScene.js?v=2.3.9';
import { HudScene } from '../scenes/HudScene.js?v=2.3.9';
