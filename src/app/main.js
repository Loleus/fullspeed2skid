...
import { MenuScene } from '../scenes/MenuScene.js?v=2.1.5';
import { LoadingScene } from '../scenes/LoadingScene.js?v=2.1.5';
import { GameScene } from '../engine/game.js?v=2.1.5';
import { HudScene } from '../scenes/HudScene.js?v=2.1.5';
