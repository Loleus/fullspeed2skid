...
export class MenuUI {
  constructor(scene) {
    ...
    this.menuStyle = {
      ...
      buttonPadding: 30,
      buttonAlpha: 0.72,
      buttonFillColor: Phaser.Display.Color.RGBStringToColor("rgb(77, 114, 28)").color,
      shadowButtonFillColor: Phaser.Display.Color.RGBStringToColor("rgba(0, 0, 0, 1)").color,
      buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgb(63, 94, 1)").color,
      ...
      customStartStyle: {
        ...
        buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgb(226, 44, 44)").color,
      ...
      customMusicStyle: {
        ...
        buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgb(0, 106, 118)").color,
