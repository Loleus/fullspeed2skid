...
import { MenuScene } from '../scenes/MenuScene.js?v=2.1.8';
import { LoadingScene } from '../scenes/LoadingScene.js?v=2.1.8';
import { GameScene } from '../engine/game.js?v=2.1.8';
import { HudScene } from '../scenes/HudScene.js?v=2.1.8';
