...
export class MenuUI {
  constructor(scene) {
    ...
    this.menuStyle = {
      ...
      buttonPadding: 30,
      buttonAlpha: 0.72,
      buttonFillColor: Phaser.Display.Color.RGBStringToColor("rgba(91, 121, 2, 1)").color,
      shadowButtonFillColor: Phaser.Display.Color.RGBStringToColor("rgba(0, 0, 0, 1)").color,
      buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgba(93, 140, 0, 1)").color,
      ...
      customStartStyle: {
        ...
        buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgba(225, 49, 0, 1)").color,
      ...
      customMusicStyle: {
        ...
        interactionRadiusOffset: 0,
        buttonFontSize: '24px',
        buttonFillColor: Phaser.Display.Color.RGBStringToColor("rgba(0, 130, 167, 1)").color,
        buttonHoverColor: Phaser.Display.Color.RGBStringToColor("rgba(0, 173, 192, 1)").color,
